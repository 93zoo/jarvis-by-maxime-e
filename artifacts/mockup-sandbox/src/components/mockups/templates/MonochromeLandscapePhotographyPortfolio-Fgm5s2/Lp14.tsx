    ...
    >
      ...
      <header className="flex items-center justify-between px-16 h-24 shrink-0 z-10">
        ...
        <button
          ...
          className="text-[11px] tracking-[0.2em] uppercase font-medium border border-white/20 px-8 py-3 cursor-pointer hover:bg-white hover:text-black active:bg-white active:text-black transition-all duration-300"
        >
          Inquire
        </button>
      </header>
